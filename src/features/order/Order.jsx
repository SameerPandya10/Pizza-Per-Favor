    ...
    <div className="space-y-6 px-4 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="rounded-full bg-red-700 px-1 py-2 text-sm font-semibold uppercase text-red-200">
              Priority
            </span>
          )}
          <span className="rounded-full bg-green-700 px-1 py-2 text-sm font-semibold uppercase text-green-200">
            {status} order
          </span>
        </div>
      </div>
